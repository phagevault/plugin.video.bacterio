...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('bacterio.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def default_setting_values(setting_id):
	if 'bacterio.' in setting_id: setting_id = setting_id.replace('bacterio.', '')
	d_settings = default_settings()
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_bacterio', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'addon_icon_choice', 'setting_type': 'string', 'setting_default': 'resources/media/addon_icons/bacterio_icon.png'},
...
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'bacterio.github.io'},
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'Bacterio', '1': 'Trakt'}},
#======+============= Trakt Cache
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.bacterio/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.bacterio/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.bacterio/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.bacterio/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'addon_icon_choice_name', 'setting_type': 'string', 'setting_default': 'bacterio_icon.png'},
