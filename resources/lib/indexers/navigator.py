...
class Navigator:
                ...
                try:
                    ...
                    cm_items = [
                        (
                            ...
                            % self.build_url(
                                {
                                    "mode": "menu_editor.move",
                                    "active_list": self.list_name,
                                    "position": count,
                                }
                            ),
                        ),
    ...
    def discover(self):
        self.add(
            {"mode": "navigator.discover_contents", "media_type": "movie"},
            "Movies",
            "movies",
        )
        self.add(
            {"mode": "navigator.discover_contents", "media_type": "tvshow"},
            "TV Shows",
            "tv",
        )
        self.end_directory()
    ...
    def easynews(self):
        self.add(
            {"mode": "navigator.search_history", "action": "easynews_video"},
            "Search Videos",
            "search",
        )
        self.add(
            {"mode": "navigator.search_history", "action": "easynews_image"},
            "Search Images",
            "search",
        )
        self.add(
            {"mode": "easynews.account_info", "isFolder": "false"},
            "Account Info",
            "easynews",
        )
        self.end_directory()
    ...
    def real_debrid(self):
        ...
        self.add(
            {"mode": "real_debrid.rd_account_info", "isFolder": "false"},
            "Account Info",
            "realdebrid",
        )
        self.end_directory()
    ...
    def premiumize(self):
        ...
        self.add(
            {"mode": "premiumize.pm_account_info", "isFolder": "false"},
            "Account Info",
            "premiumize",
        )
        self.end_directory()
    ...
    def alldebrid(self):
        ...
        self.add(
            {"mode": "alldebrid.ad_account_info", "isFolder": "false"},
            "Account Info",
            "alldebrid",
        )
        self.end_directory()
    ...
    def torbox(self):
        ...
        self.add(
            {"mode": "torbox.tb_account_info", "isFolder": "false"},
            "Account Info",
            "torbox",
        )
        self.end_directory()
    ...
    def favorites(self):
        ...
        self.add(
            {"mode": "favorite_people", "isFolder": "false", "name": "People"},
            "People",
            "empty_person",
        )
        self.end_directory()
    ...
    def my_content(self):
        ...
        self.add(
            {"mode": "navigator.trakt_lists_public"}, "Trakt Public Lists", "trakt"
        )
        if s.tmdblist_user_active():
            self.add({"mode": "tmdblist.get_tmdb_lists"}, "TMDb Lists", "tmdb")
        self.add(
            {"mode": "personal_lists.get_personal_lists"}, "Personal Lists", "lists"
        )
        self.add(
            {
                "mode": "navigator.discover_contents",
                "media_type": "movie",
                "show_new": "false",
            },
            "Discover Lists (Movies)",
            "movies",
        )
        self.add(
            {
        ...
        self.add(
            {
                ...
                "category_name": "Liked Lists",
            },
            "Trakt Liked Lists",
            "trakt",
        )
        self.add(
            {"mode": "navigator.trakt_favorites", "category_name": "Favorites"},
            "Trakt Favorites",
            "trakt",
        )
        self.add(
            {"mode": "navigator.trakt_recommendations", "category_name": "Recommended"},
            "Trakt Recommended",
            "trakt",
        )
    ...
    def trakt_lists_public(self):
        self.add(
            {
                "mode": "trakt.list.get_trakt_user_lists",
                "list_type": "trending",
                "category_name": "Trending User Lists",
            },
            "Trending User Lists",
            "trakt",
        )
        self.add(
            {
                "mode": "trakt.list.get_trakt_user_lists",
                "list_type": "popular",
                "category_name": "Popular User Lists",
            },
            "Popular User Lists",
            "trakt",
        )
        self.add(
            {"mode": "navigator.search_history", "action": "trakt_lists"},
            "Search User Lists",
            "search",
        )
        self.end_directory()
    ...
    def random_lists(self):
        self.add(
            {"mode": "navigator.build_random_lists", "menu_type": "movie"},
            "Random Movie Lists",
            "movies",
        )
        self.add(
            {"mode": "navigator.build_random_lists", "menu_type": "tvshow"},
            "Random TV Show Lists",
            "tv",
        )
        self.add(
            {"mode": "navigator.build_random_lists", "menu_type": "anime"},
            "Random Anime Lists",
            "anime",
        )
        self.add(
            {
                "mode": "navigator.build_random_lists",
                "menu_type": "because_you_watched",
            },
            "Random Because You Watched",
            "because_you_watched",
        )
        if s.tmdblist_user_active():
            self.add(
                {"mode": "navigator.build_random_lists", "menu_type": "tmdb_lists"},
                "Random TMDb Lists",
                "tmdb",
            )
        self.add(
            {"mode": "navigator.build_random_lists", "menu_type": "personal_lists"},
            "Random Personal Lists",
            "lists",
        )
        if s.trakt_user_active():
            self.add(
                {"mode": "navigator.build_random_lists", "menu_type": "trakt_personal"},
                "Random Trakt Lists (Personal)",
                "trakt",
            )
            self.add(
                {"mode": "navigator.build_random_lists", "menu_type": "trakt_public"},
                "Random Trakt Lists (Public)",
                "trakt",
            )
        self.end_directory()
    ...
    def trakt_collections(self):
        ...
        self.add(
            {
                ...
                "category_name": "Movies Collection",
            },
            "Movies Collection",
            "trakt",
        )
        self.add(
            {
                "mode": "build_tvshow_list",
                "action": "trakt_collection",
                "category_name": "TV Shows Collection",
            },
            "TV Shows Collection",
            "trakt",
        )
        self.add(
            {
                "mode": "build_movie_list",
                "action": "trakt_collection_lists",
                "new_page": "recent",
                "category_name": "Recently Added Movies",
            },
        ...
        self.add(
            {
                ...
                "action": "trakt_collection_lists",
                "new_page": "recent",
                "category_name": "Recently Added TV Shows",
            },
            "Recently Added TV Shows",
            "trakt",
        )
        self.add(
            {"mode": "build_my_calendar", "recently_aired": "true"},
        ...
        self.add(
            {
                ...
                "category_name": "Movies Watchlist",
            },
            "Movies Watchlist",
            "trakt",
        )
        self.add(
            {
                "mode": "build_tvshow_list",
                "action": "trakt_watchlist",
                "category_name": "TV Shows Watchlist",
            },
            "TV Shows Watchlist",
            "trakt",
        )
        ...
        self.add(
            {
                ...
                "category_name": "Recommended Movies",
            },
            "Movies Recommended",
            "trakt",
        )
        self.add(
            {
                "mode": "build_tvshow_list",
                "action": "trakt_recommendations",
                "category_name": "Recommended TV Shows",
            },
    ...
    def trakt_favorites(self):
        ...
        self.add(
            {
                "mode": "build_movie_list",
                "action": "trakt_favorites",
                "category_name": "Favorite Movies",
            },
            "Movies",
            "trakt",
        )
        self.add(
            {
                "mode": "build_tvshow_list",
                "action": "trakt_favorites",
                "category_name": "Favorite TV Shows",
            },
            "TV Shows",
            "trakt",
        )
    ...
    def search(self):
        self.add(
            {
                "mode": "navigator.search_history",
                "action": "movie",
                "name": "Search History Movies",
            },
            "Movies",
            "movies",
        )
        ...
        self.add(
            {
                "mode": "navigator.search_history",
                "action": "tvshow_anime",
                "name": "Search History TV Show & Anime",
            },
            "TV Show & Anime",
            "tv_anime",
        )
        ...
        self.add(
            {
                "mode": "navigator.search_history",
                "action": "tmdb_keyword_movie",
                "name": "Search History Keywords (Movies)",
            },
            "Keywords (Movies)",
            "tmdb",
        )
        self.add(
            {
                "mode": "navigator.search_history",
                "action": "tmdb_keyword_tvshow",
                "name": "Search History Keywords (TV Shows)",
            },
            "Keywords (TV Shows)",
            "tmdb",
        )
        self.add(
            {"mode": "navigator.search_history", "action": "trakt_lists"},
            "Search Trakt User Lists",
            "trakt",
        )
        if s.easynews_authorized():
            self.add(
                {"mode": "navigator.search_history", "action": "easynews_video"},
                "Search Easynews Videos",
                "easynews",
            )
            self.add(
                {"mode": "navigator.search_history", "action": "easynews_image"},
                "Search Easynews Images",
                "easynews",
            )
        self.end_directory()
    ...
    def downloads(self):
        ...
        self.add(
            {"mode": "downloader.viewer", "folder_type": "movie", "name": "Movies"},
            "Movies",
            "movies",
        )
        self.add(
            {"mode": "downloader.viewer", "folder_type": "episode", "name": "TV Shows"},
            "TV Shows",
            "tv",
        )
        self.add(
            {
                "mode": "downloader.viewer",
                "folder_type": "premium",
                "name": "Premium Files",
            },
            "Premium Files",
        ...
        self.add(
            {
                "mode": "browser_image",
                "folder_path": s.download_directory("image"),
                "isFolder": "false",
            },
            "Images",
            "people",
    ...
    def tools(self):
        ...
        if get_setting("bacterio.external_scraper.module") not in ("empty_setting", ""):
            self.add(
                {"mode": "open_external_scraper_settings", "isFolder": "false"},
                "External Scraper Settings",
                "settings",
            )
        self.add({"mode": "navigator.tips"}, "Tips for Use", "settings2")
        if (
            get_setting("bacterio.use_viewtypes", "true") == "true"
            and not get_setting("bacterio.manual_viewtypes", "false") == "true"
        ):
            self.add({"mode": "navigator.set_view_modes"}, "Set Views", "settings2")
        self.add(
            {"mode": "navigator.changelog_utils"}, "Changelog & Log Utils", "settings2"
        )
        self.add(
            {"mode": "build_next_episode_manager"},
            "TV Shows Progress Manager",
            "settings2",
        )
        self.add(
            {"mode": "navigator.shortcut_folders"},
            "Shortcut Folders Manager",
            "settings2",
        )
        self.add(
            {"mode": "navigator.maintenance"},
            "Database & Cache Maintenance",
            "settings2",
        )
        self.add(
            {"mode": "language_invoker_choice", "isFolder": "false"},
            "Toggle Language Invoker (ADVANCED!!)",
            "settings2",
        )
        self.end_directory()
    ...
    def maintenance(self):
        self.add(
            {"mode": "check_databases_integrity_cache", "isFolder": "false"},
            "Check for Corrupt Databases",
            "settings",
        )
        self.add(
            {"mode": "clean_databases_cache", "isFolder": "false"},
            "Clean Databases",
            "settings",
        )
        self.add(
            {"mode": "warm_up_memory_cache", "silent": "false", "isFolder": "false"},
            "Remake Settings Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_all_cache", "isFolder": "false"},
            "Clear All Cache (Excluding Favorites)",
            "settings",
        )
        self.add(
            {"mode": "clear_favorites_choice", "isFolder": "false"},
            "Clear Favorites Cache",
            "settings",
        )
        self.add(
            {"mode": "search.clear_search", "isFolder": "false"},
            "Clear Search History Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "main", "isFolder": "false"},
            "Clear Main Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "meta", "isFolder": "false"},
            "Clear Meta Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "list", "isFolder": "false"},
            "Clear Lists Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "ai_functions", "isFolder": "false"},
            "Clear AI Data Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "tmdb_list", "isFolder": "false"},
            "Clear TMDb Personal List Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "trakt", "isFolder": "false"},
            "Clear Trakt Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "imdb", "isFolder": "false"},
            "Clear IMDb Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "internal_scrapers", "isFolder": "false"},
            "Clear Internal Scrapers Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "external_scrapers", "isFolder": "false"},
            "Clear External Scrapers Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "rd_cloud", "isFolder": "false"},
            "Clear Real Debrid Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "pm_cloud", "isFolder": "false"},
            "Clear Premiumize Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "ad_cloud", "isFolder": "false"},
            "Clear All Debrid Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "ed_cloud", "isFolder": "false"},
            "Clear Easy Debrid Cache",
            "settings",
        )
        self.add(
            {"mode": "clear_cache", "cache": "tb_cloud", "isFolder": "false"},
            "Clear TorBox Cache",
            "settings",
        )
        self.end_directory()
    ...
    def set_view_modes(self):
        ...
        self.add(
            {
                "mode": "navigator.choose_view",
                "view_type": "view.episodes_single",
                "content": "episodes",
                "name": "episode lists",
            },
            "Set Episode Lists",
    ...
    def certifications(self):
        ...
        if menu_type == "movie":
            ...
            from modules.meta_lists import tvshow_certifications as function
        menu_type = self.params_get("menu_type")
        if menu_type == "movie":
        ...
        for i in function():
            self.add(
                {"mode": mode, "action": action, "key_id": i["id"], "name": i["name"]},
                i["name"],
                "certifications",
            )
        self.end_directory()
    ...
    def search_history(self):
        ...
        search_mode_dict = {
            ...
            "tvshow_anime": (
                "tvshow_anime_queries",
                {
                    "mode": "search.get_key_id",
                    "media_type": "tvshow_anime",
                    "isFolder": "false",
                },
            ),
            "people": (
            ...
            "easynews_video": (
                ...
                {
                    "mode": "search.get_key_id",
                    "search_type": "easynews_video",
                    "isFolder": "false",
                },
            ),
            "easynews_image": (
                "easynews_image_queries",
                {
                    "mode": "search.get_key_id",
                    "search_type": "easynews_image",
                    "isFolder": "false",
                },
            ),
            "trakt_lists": (
    ...
    def keyword_results(self):
        ...
        media_type, key_id = (
            self.params_get("media_type"),
            self.params_get("key_id") or self.params_get("query"),
        )
        try:
        ...
        action = (
            "tmdb_movie_keyword_results"
            if media_type == "movie"
            else "tmdb_tv_keyword_results"
        )
        ...
        if data["total_pages"] > page_no:
            new_page = {
                "mode": "navigator.keyword_results",
                "key_id": key_id,
                "category_name": self.category_name,
                "new_page": str(data["page"] + 1),
            }
            self.add(
                new_page, "Next Page (%s) >>" % new_page["new_page"], "nextpage", False
            )
    ...
    def choose_view(self):
        ...
        self.add(
            {
                "mode": "navigator.set_view",
                "view_type": view_type,
                "name": name,
                "isFolder": "false",
            },
            "Set view and then click here",
            "settings",
        )
    ...
    def set_view(self):
        set_setting(
            self.params["view_type"], str(k.current_window_object().getFocusId())
        )
        k.notification(
            "%s: %s"
            % (
                self.params["name"].upper(),
                k.get_infolabel("Container.Viewmode").upper(),
            ),
            time=500,
        )
    ...
    def shortcut_folders(self):
        ...
        if folders:
            for i in folders:
                ...
                convert_sr = (
                    "[B]Remove Random[/B]"
                    if "[COLOR red][RANDOM][/COLOR]" in name
                    else "[B]Make Random[/B]"
                )
                cm_items = [
                    (
                        "[B]Rename[/B]",
                        self.run_plugin
                        % self.build_url(
                            {"mode": "menu_editor.shortcut_folder_rename"}
                        ),
                    ),
                    (
                        "[B]Delete Folder[/B]",
                        self.run_plugin
                        % self.build_url(
                            {"mode": "menu_editor.shortcut_folder_delete"}
                        ),
                    ),
                    (
                        "[B]Make New Folder[/B]",
                        self.run_plugin
                        % self.build_url({"mode": "menu_editor.shortcut_folder_make"}),
                    ),
                    (
                        convert_sr,
                        self.run_plugin
                        % self.build_url(
                            {
                                "mode": "menu_editor.shortcut_folder_convert",
                                "name": name,
                            }
                        ),
                    ),
                ...
                self.add(
                    {
                        "mode": "navigator.build_shortcut_folder_contents",
                        "name": name,
                        "iconImage": "folder",
                    },
                    name,
            ...
            self.add(
                {"mode": "menu_editor.shortcut_folder_make", "isFolder": "false"},
                "[I]Make New Folder...[/I]",
                "new",
            )
    ...
    def build_shortcut_folder_contents(self):
        ...
        if is_random:
            ...
            return random_shortcut_folders(
                list_name.replace(" [COLOR red][RANDOM][/COLOR]", ""), contents
            )
        if contents:
            for count, item in enumerate(contents):
                ...
                if iconImage:
                    if (
                        ...
                        or "plugin.video.bacterio" in iconImage
                    ):
                        original_image = True
                    else:
                ...
                cm_items = [
                    (
                        ...
                        % self.build_url(
                            {
                                "mode": "menu_editor.shortcut_folder_edit",
                    ...
                    (
                        ...
                        % self.build_url(
                            {
                                "mode": "menu_editor.shortcut_folder_add",
                                "name": list_name,
                            }
                        ),
                    ),
                ...
                self.add(
                    item, item_get("name"), icon, original_image, cm_items=cm_items
                )
        elif is_random:
            pass
        else:
    ...
    def discover_contents(self):
        ...
        if not action:
            if self.params_get("show_new", "true") == "true":
                self.add(
                    {
                        "mode": "discover_choice",
                        "media_type": media_type,
                        "isFolder": "false",
                    },
                    "[I]Make New Discover List...[/I]",
                    "new",
                )
            ...
            for item in results:
                ...
                if "[random]" in data:
                    ...
                    self.add(
                        {"mode": mode, "action": action, "name": name, "url": data},
                        name,
                        "discover",
                        cm_items=cm_items,
                    )
    ...
    def tips(self):
        tips_location = (
            "special://home/addons/plugin.video.bacterio/resources/text/tips"
        )
        ...
        for item in files:
            ...
            if "!!HELP!!" in tip:
                tip, sort_order = (
                    tip.replace("!!HELP!!", "[COLOR crimson][B]HELP!!![/B][/COLOR] "),
                    0,
                )
            elif "!!NEW!!" in tip:
                tip, sort_order = (
                    tip.replace("!!NEW!!", "[COLOR chartreuse][B]NEW!![/B][/COLOR] "),
                    1,
                )
            elif "!!SPOTLIGHT!!" in tip:
                tip, sort_order = (
                    tip.replace(
                        "!!SPOTLIGHT!!", "[COLOR orange][B]SPOTLIGHT![/B][/COLOR] "
                    ),
                    2,
                )
            else:
            ...
            params = {
                "mode": "show_text",
                "heading": tip,
                "file": k.translate_path(tips_location % item),
                "font_size": "large",
                "isFolder": "false",
            }
    ...
    def because_you_watched(self):
        ...
        action_dict = {
            "movie": {
                "mode": "build_movie_list",
                "action": {
                    0: "tmdb_movies_recommendations",
                    1: "imdb_more_like_this",
                    2: "ai_similar",
                    3: "trakt_movies_related",
                },
                "media_type": "movie",
            },
            "tvshow": {
        ...
        mode, action, media_type = (
            action_params["mode"],
            action_params["action"][recommend_type],
            action_params["media_type"],
        )
        ...
        for item in recently_watched:
            if media_type == "movie":
                ...
                key_id = (
                    item["media_id"]
                    if recommend_type in (0, 1, 3)
                    else "movie|%s" % item["media_id"]
                )
            else:
                name = "%s - %sx%s" % (
                    item["title"],
                ...
                key_id = (
                    item["media_ids"]["tmdb"]
                    if recommend_type in (0, 1, 3)
                    else "tvshow|%s" % item["media_ids"]["tmdb"]
                )
            params = {
                "mode": mode,
                "action": action,
                "key_id": key_id,
                "name": "Because You Watched %s" % name,
            }
            if recommend_type == 1:
    ...
    def build_random_lists(self):
        random_list_dict = {
            ...
            "because_you_watched": (
                "Random Because You Watched Lists",
                nc.random_because_you_watched_lists,
            ),
            "tmdb_lists": ("Random TMDb Lists", nc.random_tmdb_lists),
            "personal_lists": ("Random Personal Lists", nc.random_personal_lists),
            "trakt_personal": (
                "Random Trakt Lists (Personal)",
                nc.random_trakt_lists_personal,
            ),
            "trakt_public": (
                "Random Trakt Lists (Public)",
                nc.random_trakt_lists_public,
            ),
        }
